    ...
    with zipfile.ZipFile(zip_filename, 'w', zipfile.ZIP_DEFLATED) as zipf:
        for root, dirs, files in os.walk(folder_to_zip):
            for file in files:
                ...
                if file != os.path.basename(__file__) and file != zip_filename and file != "schluessel.txt" and file != "zip_dehack.py" and file != "start.sh":
...
def delete_files_and_folders(folder_to_clean, zip_filename):
    for item in os.listdir(folder_to_clean):
        ...
        if item != os.path.basename(__file__) and item != zip_filename and item != "schluessel.txt" and item != "zip_dehack.py" and item != "start.sh":
